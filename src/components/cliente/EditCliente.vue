  ...
  <div class="hello">
    ...
    <q-card flat bordered>
      <q-card-section class="bg-grey-2 my-card">
        <div class="text-h5 text-center">Editar Cliente</div>
      </q-card-section>
      ...
      <q-card-section class="bg-grey-2 my-card">
        ...
        <div class="row q-mt-md">
          <div class="col-12 col-md-6 q-pa-xs">
            <q-input outlined v-model="cliente.nombre" label="Nombre *" counter maxlength="50" />
          </div>
          <div class="col-12 col-md-6 q-pa-xs">
            <q-input outlined v-model="cliente.email" label="Correo Electrónico *" counter maxlength="100" type="email"/>
          </div>
        </div>
        ...
        <div class="row q-mt-md">
          ...
          <div class="col-12 col-md-4 q-pa-xs">
            <q-input outlined v-model="cliente.telefono" label="Teléfono" counter maxlength="15" />
          </div>
          <div class="col-12 col-md-4 q-pa-xs">
            <q-input outlined v-model="cliente.direccion" label="Dirección" counter maxlength="100" />
          </div>
        </div>
    ...
    <q-dialog v-model="alert">
      <q-card style="width: 500px; max-width: 70vw;">
        ...
        <q-card-section class="q-pt-none">
          ¿Está seguro de editar el cliente?
        </q-card-section>
...
export default defineComponent({
  ...
  methods: {
    ...
    getData() {
      ...
      ClienteService.get(this.$route.params.id)
        .then((response: any) => {
          Loading.hide();
    ...
    onGuardar() {
      ...
      ClienteService.update(this.$route.params.id, data)
        .then((response: any) => {
          Loading.hide();
          if(response.data.status) {
            this.cliente = response.data.data;
